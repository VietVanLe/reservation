...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleSubmitLogin: function handleSubmitLogin() {
      ...
      _services__WEBPACK_IMPORTED_MODULE_0__.UserService.login(this.form).then(function (response) {
        _this.$router.push({
          name: 'home'
        }, function () {});
...
/* harmony export */   "UserService": () => (/* reexport safe */ _userService__WEBPACK_IMPORTED_MODULE_1__["default"])
/* harmony export */ });
...
/* harmony import */ var _userService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./userService */ "./resources/js/services/userService.js");
...
var UserService = {
  login: function login(data) {
    return _apiService__WEBPACK_IMPORTED_MODULE_0__["default"].post('/api/auth/login', data);
  }
};
