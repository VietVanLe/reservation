...
var render = function render() {
  ...
  }, [_vm._v('" type="email" required\n                :class="{ \'is-invalid\': submitted && $v.user.email.$error }">'), _vm._v(" "), _vm.submitted && _vm.$v.user.email.$error ? _c("div", {
    staticClass: "invalid-feedback"
  }, [!_vm.$v.form.email.required ? _c("span", [_vm._v("Email is required")]) : _vm._e(), _vm._v(" "), !_vm.$v.form.email.email ? _c("span", [_vm._v("Email is invalid")]) : _vm._e()]) : _vm._e(), _vm._v(" "), _c("b-form-group", {
    attrs: {
  ...
  }), _vm._v(" "), _vm.submitted && _vm.$v.user.password.$error ? _c("div", {
    staticClass: "invalid-feedback"
  }, [!_vm.$v.user.password.required ? _c("span", [_vm._v("Password is required")]) : _vm._e(), _vm._v(" "), !_vm.$v.user.password.minLength ? _c("span", [_vm._v("Password must be at least 6 characters")]) : _vm._e()]) : _vm._e()], 1), _vm._v(" "), _c("b-form-group", [_c("b-button", {
    attrs: {
      type: "submit",
